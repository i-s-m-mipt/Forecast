...
namespace solution
{
	namespace plugin
	{
		...
		// ¬ текущей реализации предполагетс€ 2 варианта направлени€
		// движени€ поездов - в пр€мом и в обратном направлении, дл€
		// удобства были выбраны обозначени€ север и юг. ≈сли будут 
		// рассматриватьс€ участки со сложной топологией (кольца,
		// восьмерки и т.п.), то подход также применим, однако он
		// потребует уточнени€.
